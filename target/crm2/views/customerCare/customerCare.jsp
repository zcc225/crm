	...
	layui.use([ 'table', 'form', 'laydate','element' ], function() {
	        ...
	        table.render({
	            ...
	            cols : [ [
	                ...
	                },
	                {
	                    ...
	                    title : "待办日期",
	                    templet : function(data) {
	                        return Format(data.birthday, 'MM月dd日')+"<span style='color:red;'>"+brthDate(Format(data.birthday, 'MM'),Format(data.birthday, 'dd'))+"</span>";
	                    }
	                },
	                {
	                    field : "detail",
		...
		table.on('tool(customerCareTableA)', function(obj) {
            ...
            //查看编辑关怀
            	...
            	layer.confirm('确定要忽略该联系人的时间吗?', function(index) {
                    layer.close(index);
    	...
    	$("#addBtn").click(function() {
    		showAddOrEditOpportunityPage("添加待办事项", -1);
    	})
    	...
    	function showAddOrEditOpportunityPage(title, id) {
    		...
    		var url = 'views/customerCare/addCustomerCare.jsp';
    		if (id > 0) {
    			url += '?id=' + id;
    		}
    		layer.open({
